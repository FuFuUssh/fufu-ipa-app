...
export default function BeforeUpdateConfirm() {
    ...
    return (
        <div className="auth-section">
            ...
            <form className="form card" onSubmit={handleLogin}>
                <h2 className="form-title">Hey you</h2>
                <h5 className="form-subtitle">Let's us know it's you before proceeding to the update</h5>
